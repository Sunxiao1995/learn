...
<div class="soubg">
	<div class="sou">
        ...
        <span class="fr">
             ...
             %>
                &nbsp;|&nbsp;<a href="Member_orderServlet.do">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
                    ...
                    <%
                        ...
                        if(object != null){
                            ...
                            for (Product product : productList) {
                                out.print("                    <li>\n" +
                                        "                        <div class=\"img\"><a href=\"product.do?productId="+product.getId()+"\"><img src=\"images/"+product.getFileName()+"\" width=\"210\" height=\"185\"/></a></div>\n" +
                                        "                        <div class=\"price\">\n" +
