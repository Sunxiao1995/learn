    ...
    <div class="content mar_20">
    	<div class="two_bg">
            ...
            <table border="0" class="car_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
              ...
              <c:forEach items="${sessionScope.addCar }" var="item" varStatus="status">
          	<c:choose>
              ...
              <tr>
                <td colspan="5" align="right" style="font-family:'Microsoft YaHei';">
                    商品总价：￥${sessionScope.totalPrice} ； 返还积分 56R
                </td>
              </tr>
            </table>
            ...
            <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
              ...
              <tr height="70">
                <td align="right">
                	<b style="font-size:14px;">应付款金额：<span style="font-size:22px; color:#ff4e00;">${sessionScope.totalPrice}</span></b>
                </td>
              </tr>
              <tr height="70">
                <td align="right"><a href="createOrder"><img src="images/btn_sure.gif" /></a></td>
              </tr>
            </table>
