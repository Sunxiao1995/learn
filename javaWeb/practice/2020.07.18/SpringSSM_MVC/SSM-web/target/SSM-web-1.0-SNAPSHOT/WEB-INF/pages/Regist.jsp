    ...
    <script>
      $(function () {
        $(".log_btn").click(function(){
          ...
          var password2 = $("#l_pwd").val();
          var email = $(".l_email").val();
          var tel = $(".l_tel").val();


          if (password === "" || username === "" || password2 === "" || email === "" || tel === ""){
            alert("*标识不能为空！！！")
...
<div class="log_bg">	
	...
	<div class="regist">
		...
		<div class="reg_c">
        	<form action="register" method="post" id="subFrom">
            <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
              <tr height="50" valign="top">
              	<td width="95">&nbsp;</td>
                <td>
                	<span class="fl" style="font-size:24px;">注册</span>
                    <span class="fr">已有商城账号，<a href="/loginPre" style="color:#ff4e00;">我要登录</a></span>
                </td>
              </tr>
              <tr height="50">
