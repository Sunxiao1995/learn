	...
	<div class="m_content">
   		<div class="m_left">
            ...
            <div class="left_m">
                ...
                <ul>
                	<li><a href="Member_order">我的订单</a></li>
                    <li><a href="Member_Address" class="now">收货地址</a></li>
                    <li><a href="#">缺货登记</a></li>
                    <li><a href="#">跟踪订单</a></li>
                </ul>
            </div>
            <div class="left_m">
                ...
                <ul>
                	<li><a href="Member_User">用户信息</a></li>
        ...
        <%Object obj1 = session.getAttribute("address");
            Address address = (Address) obj1;
        %>
		...
		<div class="m_right">
			...
			<div class="address">
            	...
            	<table border="0" class="add_t" align="center" style="width:98%; margin:10px auto;" cellspacing="0" cellpadding="0">
                  <tr>
                    <td colspan="2" style="font-size:14px; color:#ff4e00;"><%=address.getRemake()%></td>
                  </tr>
                  <tr>
            ...
            <table border="0" class="add_tab" style="width:930px;"  cellspacing="0" cellpadding="0">
              ...
              <tr>
           	...
           	<p align="right">
            	<a href="#">删除</a>&nbsp; &nbsp; <a href="saveAddress" class="add_b">确认修改</a>
            </p> 
