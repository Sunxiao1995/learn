...
<div class="soubg">
        ...
        <span class="fr">
        	<span class="fl">
                            <c:if test="${sessionScope.user!=null}">
                                <span class="fl"><a href="#">${sessionScope.user.loginName}</a>&nbsp;|&nbsp;<a href="Member_order">我的订单</a>&nbsp;</span>
                                <span class="fl">|&nbsp;<a href="logout" >注销</a></span>
                            </c:if>
 ...
 <c:if test="${sessionScope.user==null}">
     ...
     <span class="fl">你好,请<a href="loginPre" style="color:#ff4e00;">登录</a>&nbsp;
       <a href="registerPre" style="color:#ff4e00;">免费注册</a>&nbsp;&nbsp;
     </span>
     </c:if>
     <c:if test="${! empty sessionScope.loginName }">
         <span class="fl"><a href="#">${sessionScope.loginName}</a>&nbsp;|&nbsp;<a href="Member_order"> 我的订单</a>&nbsp;</span>
         <span class="fl">|&nbsp;<a href="logout" >注销</a></span>
     </c:if>
 </c:if>
        	<span class="ss">
...
<
                ...
                <td align="center">
                    <div class="c_num">
                        ...
                        <input type="text" value=<%=cart.get(product)%> name="" class="car_ipt" />
                        <input type="button" value="" onclick="addUpdate1(jq(this));" class="car_btn_2" />
                    </div>
                </td>
                <td align="center" style="color:#ff4e00;">￥<%=product.getPrice()*cart.get(product)%></td>
            ...
            <tr valign="top" height="150">
                <td colspan="6" align="right">
                    <a href="#"><img src="images/buy1.gif" /></a>&nbsp; &nbsp; <a href="confirmOrder"><img src="images/buy2.gif" /></a>
                </td>
            </tr>
        </table>
