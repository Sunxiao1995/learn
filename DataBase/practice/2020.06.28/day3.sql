...
from fruits f1 inner join fruits f2 
on f1.s_id = f2.s_id 
where f2.f_id = 'a1';
...
select o.o_num,o.o_date 
from orders o where o_num=30001;
...
from student inner join score
on student.id = score.stu_id
where score.grade<95 and c_name='计算机';

-- 查询同时参加计算机和英语考试的学生的信息
select a.*,d.c_name,d.grade from 
(select b.*,c.c_name,c.grade from student b 
...
from student inner join score
on student.id = score.stu_id
where student.name like '王%' or student.name like '张%';
